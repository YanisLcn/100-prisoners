...
\begin{figure}[h]
  \includegraphics[width=\linewidth]{./graphe_permutation.png}
  \caption{Représentation des cycles d'une permutation sous forme de graphe à 100 sommets.}
  \label{fig:graphe_permutation}
\end{figure}
